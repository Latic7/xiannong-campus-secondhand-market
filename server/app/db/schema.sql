...
-- 正在导出表  campus_market.orders 的数据：~5 rows (大约)
INSERT INTO `orders` (`id`, `product_id`, `buyer_id`, `seller_id`, `amount`, `remark`, `status`, `created_at`, `expire_at`) VALUES
	...
	(5003, 1001, 12, 1, 35.00, NULL, 'RESERVED', '2026-06-21 15:15:37', '2026-06-23 07:15:37'),
	(5004, 1003, 12, 1, 45.00, NULL, 'RESERVED', '2026-06-21 15:15:49', '2026-06-23 07:15:49'),
...
INSERT INTO `products` (`id`, `owner_id`, `title`, `description`, `price`, `category_id`, `status`, `created_at`, `updated_at`, `favorite_count`, `view_count`) VALUES
	(1001, 1, '二手高数教材', '九成新，可小刀', 35.00, 2, 'PUBLISHED', '2026-06-12 11:30:55', '2026-06-21 07:15:32', 2, 14),
	(1002, 1, '二手计算机网络教材', '有少量笔记', 28.00, 2, 'PUBLISHED', '2026-06-12 11:30:55', '2026-06-12 11:30:55', 1, 5),
	(1003, 1, '二手充电宝', '容量20000mAh', 45.00, 1, 'PUBLISHED', '2026-06-12 11:30:55', '2026-06-21 07:15:47', 0, 4),
...
INSERT INTO `reports` (`id`, `reporter_id`, `target_type`, `target_id`, `reason`, `status`, `assignee_id`, `handle_action`, `handle_reason`, `created_at`, `handled_at`) VALUES
	(7001, 2, 'PRODUCT', 1001, '疑似虚假信息', 'HANDLED', 10, 'ban_user', '封禁用户', '2026-06-12 11:30:55', '2026-06-21 07:14:57'),
...
INSERT INTO `users` (`id`, `openid`, `nickname`, `avatar`, `score`, `status`, `is_admin`, `college`, `contact`, `created_at`, `updated_at`) VALUES
	...
	(11, 'orK423WwnIFshGd54OkS-nY5-gNM', 'WX_Y5-gNM', '', 100, 'ACTIVE', 0, NULL, NULL, '2026-06-12 11:31:42', '2026-06-21 15:13:53'),
	(12, 'orK423YBS6RWhiNkzNemYBPZJ_Pk', 'WX_PZJ_Pk', '', 100, 'ACTIVE', 0, NULL, NULL, '2026-06-21 15:12:32', '2026-06-21 15:16:04');
